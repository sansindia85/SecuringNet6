...
{ 
    ...
    public class GalleryController : Controller
    {
        ...
        public async Task Logout()
        {
            ...
            #region Can be Commented out for testing purpose. Token revocation.
            //Logging out of our web application
            await HttpContext.SignOutAsync(CookieAuthenticationDefaults.AuthenticationScheme);

            //Logging out of the identity provider
            //Redirect to end session of identity provider.
            //This is required as client cannot clear the cookie from identity provider.
        ...
        public async Task<IActionResult> OrderFrame()
        {
            ...
            //Uses IdentityModel HTTPClient extension
            var metaDataResponse = await idpClient.GetDiscoveryDocumentAsync();

            if (metaDataResponse.IsError)
            {
                throw new Exception("Problem accesing the discovery endpoint.", metaDataResponse.Exception);
            }
